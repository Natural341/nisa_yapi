                  ...
                  <div key={item.id} className="modern-card p-6">
                    <div className="flex flex-col sm:flex-row gap-6">
                      ...
                      <div className="flex-shrink-0">
                        <Link href={`/urun/${item.id}`} className="block w-32 h-32 bg-light border border-border rounded overflow-hidden hover:border-dark transition-colors flex items-center justify-center">
                          {item.image ? (
                            <Image
                              src={item.image}
                              alt={item.name}
